...
public class MapperAnnotationBuilder {
    ...
    private void loadXmlResource() {
        ...
        if (!configuration.isResourceLoaded("namespace:" + type.getName())) {
            /*
             * 得到XXXMapper.xml文件路径
             * com/loserico/mybatis/eden/mapper/UserMapper.xml
             */
            ...
            if (inputStream != null) {
                XMLMapperBuilder xmlParser =
                    new XMLMapperBuilder(inputStream, assistant.getConfiguration(), xmlResource, configuration.getSqlFragments(), type.getName());
                xmlParser.parse();
            }
        }
    }
